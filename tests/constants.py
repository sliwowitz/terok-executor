...
EXAMPLE_PROVIDER_HOST = "api.example.com"
EXAMPLE_PROVIDER_UPSTREAM = f"https://{EXAMPLE_PROVIDER_HOST}"
"""Synthetic endpoint used by custom-provider examples and schema tests."""
